    ...
    function html5Upload() {	
    	...
    	sUploadURL = '/smarteditorSample/file_uploader_html5.jsp' //upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 	    	...
 	    	sUrl : '/smarteditorSample/file_uploader.jsp',
 	    	sCallback : '/smarteditorSample/SE2/photo_uploader/popup/callback.html',
